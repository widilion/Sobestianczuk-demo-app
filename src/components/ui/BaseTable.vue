...
type TableData = {  //definiuje typ: array of objects
  id: String;
  name: String;
  year: String;
  color: String;
...
const props = defineProps({
  contents: { type: Array as PropType<TableData>, default: null, required: false }, //definiuje potrzebny props jako array of objects
